...
<body>
    ...
    <form action="" method="POST">
            ...
            <div class="col-2">
                <div class="row-2">
                    <div class="input-container">
                        ...
                        <input type="text" name="user_name" id="" placeholder="M Arslan" title="username"
                            value="<?php echo $user_db_data['user_name']; ?>">

                        <label for="">Email</label>
                        <input type="email" name="user_email" id="" placeholder="123456@gmail.com"
                            value="<?php echo $user_db_data['user_email']; ?>">
                        ...
                        <input type="text" name="user_address" id="" placeholder="524 gujranwala ..."
                            value="<?php echo $value['user_address']; ?>" required>
                        <label for="">City</label>
                        <input type="text" name="user_city" id="" placeholder="Gujranwala"
                            value="<?php echo $value['user_city']; ?>" required>
                        <div class="row-2">
                            <div class="input-container">
                                <label for="">Zip</label>
                                <input type="text" name="user_zip" id="" placeholder="52250"
                                    value="<?php echo $value['user_zip']; ?>" required>
                            </div>
                            <div class="input-container">
                                <label for="">State</label>
                                <input type="text" name="user_state" id="" placeholder="gujranwala"
                                    value="<?php echo $value['user_state']; ?>" required>
                            </div>
                        </div>
                        <?php
                                            }
                    ...
                    <div class="input-container">
                        ...
                        <div class="icon-container">
                            ...
                            <a href="mastercard"><i class="fab fa-cc-mastercard"
                                    style="color:red; font-size: 40px;"></i></a>
                            <a href="discover"><i class="fab fa-cc-discover"
                                    style="color:orange; font-size: 40px;"></i></a>
                            <a href="paypal"><i class="fab fa-cc-paypal"
                                    style="color:#3b7bbf; font-size: 40px;"></i></a>
                            <a href="amazon-pay"><i class="fab fa-cc-amazon-pay"
                                    style="color:#FF9900; font-size: 40px;"></i></a>
                        </div>
            ...
            <div class="col-3">
                ...
                <div class="heading"
                    ...
                    <div class="heading-subheading"
                        style="display: flex; flex-basis: 70%; justify-content: space-between;">
                ...
                <div class="right_side">
                    ...
                    <?php
                                    ...
                                    ?>
                    <div class="products"
                        style="background: #fff; display: flex; justify-content: space-between; border-radius: 10px; margin-top: 10px; padding: 10px; align-items: center;">
                        <div class="product_img">
                            <img src="img\product_img\<?php echo $product["product_image"]; ?>"
                                alt="<?php echo $product["product_name"]; ?>"
                                style="height: 60px; width: 60px; border-radius: 50%; flex-basis: 20%;">
                        </div>
                        <div class="product_name_price"
                            style="display: flex; justify-content: space-between; flex-basis: 80%;">
        ...
        <div class="row">
            <button class="place_order" type="submit" name="placeorder"
                style="background: #ff523b;padding: 10px;text-align: center;color: #fff; border-radius: 10px;outline: none;border: none;font-size: 15px; justify-content: center;">Place
                Order</button>
        </div>
    </form>
    <?php

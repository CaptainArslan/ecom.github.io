...
<body>
    ...
    if (isset($_POST['placeorder'])) {
        ...
        if ($order == true) {
            ...
            ?>
            <table style="max-width:670px;margin:50px auto 10px;background-color:#fff;padding:50px;-webkit-border-radius:3px;-moz-border-radius:3px;border-radius:3px;-webkit-box-shadow:0 1px 3px rgba(0,0,0,.12),0 1px 2px rgba(0,0,0,.24);-moz-box-shadow:0 1px 3px rgba(0,0,0,.12),0 1px 2px rgba(0,0,0,.24);box-shadow:0 1px 3px rgba(0,0,0,.12),0 1px 2px rgba(0,0,0,.24); border-top: solid 10px #ffd6d6;">
                <thead>
                    <tr>
                        <th style="text-align:left;"><img style="max-width: 150px;" src="img/logos/logo.png" alt="bachana tours"></th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="width:50%;padding:20px;vertical-align:top">
                            <p style="margin:0 0 10px 0;padding:0;font-size:14px; text-transform: capitalize;"><span style="display:block;font-weight:bold;font-size:13px ">Name</span><?php echo $name; ?></p>
                            ...
                            <p style="margin:0 0 10px 0;padding:0;font-size:14px;"><span style="display:block;font-weight:bold;font-size:13px;">Phone</span> <?php echo $phone ?></p>
                            <p style="margin:0 0 10px 0;padding:0;font-size:14px;"><span style="display:block;font-weight:bold;font-size:13px;">ID No.</span><?php echo $id; ?></p>
                        </td>
                        <td style="width:50%;padding:20px;vertical-align:top">
                            <p style="margin:0 0 10px 0;padding:0;font-size:14px;"><span style="display:block;font-weight:bold;font-size:13px;">Address</span> Kachha Fattomand Road Gujranwala</p>
                            <p style="margin:0 0 10px 0;padding:0;font-size:14px;"><span style="display:block;font-weight:bold;font-size:13px;">City</span>Gujranwala</p>
                            <p style="margin:0 0 10px 0;padding:0;font-size:14px;"><span style="display:block;font-weight:bold;font-size:13px;">Zip / Postal Code</span>52250</p>
                        </td>
                    </tr>
                    <tr>
                    ...
                    < <tr>
                        <td colspan="2" style="padding:15px;">
                            <p style="margin:0;padding:10px;border:solid 1px #ddd;">
                                <span style="display:block;font-size:13px;font-weight:normal;">Total Quantity = <?php echo $total_quantity; ?> </span> 
                                <span style="display:block;font-size:13px;font-weight:normal;">Total Tax = <?php echo $total_tax; ?> </span>
                                <span style="display:block;font-size:13px;font-weight:normal;">Grand Total = <?php echo $grand_total; ?></span>
                            </p>
                        </td>
                        </tr>
                </tbody>

...
<body>
                    ...
                    <div class="col-2">
                        <div class="row-2">
                            <div class="input-container">
                                ...
                                <input type="text" name="" id="" placeholder="M Arslan" title="username" value="<?php echo $user_db_data['user_id']; ?>" required> -->

                                <label for="">User Name</label>
                                <input type="text" name="user_name" id="" placeholder="M Arslan" title="username" value="<?php echo $user_db_data['user_name']; ?>" required>

                                <label for="">Email</label>
                                <input type="email" name="user_email" id="" placeholder="123456@gmail.com" value="<?php echo $user_db_data['user_email']; ?>" required>
    ...
    if (isset($_POST['placeorder'])) {
        ...
        $insert_address_data = mysqli_query($con, "INSERT INTO `tbl_user_address`(`user_id`, `user_address`, `user_city`, `user_state`, `user_zip`) 
            VALUES ('$user_id','$address','$city','$state','$zip')");

        if ($insert_address_data) {
            echo '<script>
                alert("Address data inserted successfullly")
            </script> ';
        } else {
            echo '<script>
                alert("Error occur while address data inserted")
            </script> ';
        }
    }
    ?>
